  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-10 bg-card text-card-foreground shadow-lg border border-border p-6",
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("text-title-h5 font-semibold leading-none tracking-tight", className)}
    {...props}
  />
));
